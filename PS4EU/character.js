	...
	try{
		request(options, function (error, response, body) {
			...
			if (data.character_list == null || data.returned == 0)
			{
				...
				//fisu URL
				sendEmbed.setURL('http://ps4eu.ps2.fisu.pw/player/?name='+cName);
				...
				if(resChar.stats != undefined){
					...
					try{
						...
						weapURI = 'https://census.daybreakgames.com/s:'+process.env.serviceID+'/get/ps2ps4eu:v2/item/'+topID;
